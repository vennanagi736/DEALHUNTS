...
/* -------------------------------------------------------------------------
   ...
   Low Stock, Complaints and Feedback sections.
------------------------------------------------------------------------- */
      ...
      {points.map((p, i) => (
        ...
        <g key={p.label}>
          ...
          <circle
            ...
            className={
              i === points.length - 1
                ? "db-chart-dot db-chart-dot-active"
                : "db-chart-dot"
            }
          />
...
function AdminHome() {
  ...
  /* ============================================================
     ADDITIONAL ADMIN OPERATIONS METRICS
  ============================================================ */
  ...
  useEffect(() => {
    ...
    const loadTrending = async () => {
      ...
      try {
        ...
        console.log(
          "Dashboard: calling promotions API"
        );
        ...
        <div className="db-grid">
          ...
          <aside className="db-left">
            ...
            {adminOperations.map((op) => (
              ...
              <div
                className="db-op-card"
                key={op.label}
              >

                <span className="db-op-icon">
                  {op.icon}
                </span>


                <span className="db-op-value">
                  {op.value}
                </span>


                <span className="db-op-label">
                  {op.label}
                </span>
                  ...
                  <tbody>
                    ...
                    {TOP_PRODUCTS.map((p) => (
                      ...
                      <tr key={p.rank}>
                        ...
                        <td className="db-table-product">
                          {p.name}
                        </td>


                        <td className="db-table-secondary">
                          {p.category}
                        </td>


                        <td className="db-table-navy">
                          {p.sales}
                        </td>
          ...
          <aside className="db-right">
            ...
            <div className="db-right-card db-trending-card">
              ...
              <h2 className="db-card-title db-trending-title">
                Trending Products
              </h2>
              ...
              <ul className="db-mini-list">
                ...
                {LOW_STOCK_ITEMS.map((item) => (
                  ...
                  >
                    ...
                    <span className="db-lowstock-badge">
                      {item.left} left
                    </span>
            ...
            <div className="db-right-card">
              ...
              <ul className="db-mini-list">
                ...
                <li className="db-mini-row">
                  ...
                  <span className="db-count-badge db-count-alert">
                    {String(
                      complaintsCount
                    ).padStart(2, "0") || "04"}
                  </span>
                ...
                <li className="db-mini-row">
                  ...
                  <span className="db-count-badge db-count-ok">
                    32
                  </span>
                ...
                {FEEDBACK_ITEMS.map((f, i) => (
                  ...
                  >
                    ...
                    <span className="db-feedback-stars">
                      ...
                      <span className="db-feedback-stars-empty">
                    ...
                    <p className="db-feedback-message">
                      “{f.message}”
                    </p>
